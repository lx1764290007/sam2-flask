...
# COPY D:/works/segment-anything/sam2/checkpoints/checkpoints/sam2.1_hiera_tiny.pt ${APP_ROOT}/checkpoints/sam2.1_hiera_tiny.pt.backend
# COPY D:/works/segment-anything/sam2/checkpoints/checkpoints/sam2.1_hiera_small.pt ${APP_ROOT}/checkpoints/sam2.1_hiera_small.pt.backend
# COPY D:/works/segment-anything/sam2/checkpoints/checkpoints/sam2.1_hiera_base_plus.pt ${APP_ROOT}/checkpoints/sam2.1_hiera_base_plus.pt.backend
# COPY D:/works/segment-anything/sam2/checkpoints/checkpoints/sam2.1_hiera_large.pt ${APP_ROOT}/checkpoints/sam2.1_hiera_large.pt.backend

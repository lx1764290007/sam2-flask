...
APP_ROOT = os.getenv("APP_ROOT", "/usr/local/segment_flask/server")
...
DATA_PATH = Path(os.getenv("DATA_PATH", "/usr/local/segment_flask/server/data"))
...
DEFAULT_CHECK_POINT_YAML_PATH: str = os.getenv("CHECK_POINT_CONFIG_PATH", "/usr/local/segment_flask/server/checkpoints/config")
